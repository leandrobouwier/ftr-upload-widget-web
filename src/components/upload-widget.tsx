  ...
  return (
    <Collapsible.Root onOpenChange={() => toggleWidgetOpen()} asChild>
      <motion.div
        ...
        className="bg-zinc-900 overflow-hidden w-[560px] rounded-xl data-[state=open]:shadow-shape border border-transparent 
        animate-border data-[state=closed]:rounded-3xl data-[state=closed]:data-[progress=false]:shadow-shape  
